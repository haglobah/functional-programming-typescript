              ...
              <Match when={loadingState()}>
                {(loading) => (
                  <div class="text-center py-4">
                    ...
                    <p class="text-purple-300 font-medium">Loading {loading().track.title}...</p>
                  </div>
                )}
              </Match>
                    ...
                    <div class="mb-6">
                      <div class="relative group">
                        <input
                          ...
                          style={{
                            background: `linear-gradient(to right, rgb(168 85 247) 0%, rgb(236 72 153) ${(active().currentTime / active().duration) * 100}%, rgb(71 85 105) ${(active().currentTime / active().duration) * 100}%, rgb(71 85 105) 100%)`,
                          }}
                        />
                      </div>
